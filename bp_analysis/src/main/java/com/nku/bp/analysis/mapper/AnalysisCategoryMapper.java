...
public class AnalysisCategoryMapper extends TableMapper<Text,Text> {
    ...
    protected void map(ImmutableBytesWritable key, Result value, Context context)
        ...
        // 将数据拼接，传给reducer
        String data = getK(view)+"_"+getK(like)+"_"+getK(coin)+"_"+getK(collect)+"_"+getK(share);
        context.write(new Text(cate),new Text(data));
